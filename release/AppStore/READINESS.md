...
- [ ] Confirm the remaining listing metadata. Robert approved the 29-character App Store product name `Clasp: Private Markdown Notes`; the installed app remains `Clasp`. Subtitle, description, keywords, category, pricing/availability, copyright, and support contact still require final review.
